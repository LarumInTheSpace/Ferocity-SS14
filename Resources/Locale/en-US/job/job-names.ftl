...
job-name-chaplain = Preacher
job-name-botanist = Botanist
job-name-bartender = Bartender
job-name-passenger = Laborer
job-name-salvagespec = Miner
job-name-qm = Chief Miner
...
JobPassenger = Laborer
JobPsychologist = Psychologist
JobQuartermaster = Chief Miner
JobReporter = Reporter
JobResearchDirector = Research Director
JobSalvageSpecialist = Miner
